...
```
## C2. Finding focus words: functions
I wrote functions to:
(1) create a wordcloud 
(2) filter the words in articles in the top and bottom quartiles of articles based on a given sentiment_score
(3) display the freqeutnly used words

```{r}
source("filtering_functions.R")
```

## C3. Displaying data: intersting results
